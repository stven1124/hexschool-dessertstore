<template>
  <div>
    <div class="text-right">
      <button class="btn btn-secondary mt-2" @click="openCouponModal(true)">建立新的優惠券</button>
    </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-pinkdark text-white" @click="updateCoupon">更新優惠券</button>
          </div>
        </div>
      </div>
    </div>
    <DelModal id="delCouponModal" :modalData="tempCoupon" @delCheck="delCoupon"></DelModal>
  </div>
</template>
